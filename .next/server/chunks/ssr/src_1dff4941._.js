...
const CatePage = ()=>{
    ...
    const handleGetBlogs = async ()=>{
        setLoading(true);
        try {
            const res = await fetch(`http://localhost:1337/api/blogs?filters[cate][documentId][$eq]=${params.slug}&populate=cover&pagination[page]=${page}&pagination[pageSize]=3`);
            const data = await res.json();
            setBlogs(data.data);
...
//# sourceMappingURL=src_1dff4941._.js.map