...
function Home() {
    ...
    const handleGetPost = async (pageNumber)=>{
        setLoading(true);
        try {
            const response = await fetch(`http://localhost:1337/api/blogs?pagination[page]=${pageNumber}&pagination[pageSize]=3&populate=*`);
            const data = await response.json();
...
//# sourceMappingURL=src_3acf4ff2._.js.map