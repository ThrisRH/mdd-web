...
const page = ()=>{
    ...
    const handleGetBlog = async ()=>{
        setLoading(true);
        try {
            const response = await fetch(`http://localhost:1337/api/blogs/${params.slug}?populate[subContent][populate]=*&populate[cate][populate]=*&populate[optionImage][populate]=*&populate=cover`, {
                method: "GET"
            });
            const data = await response.json();
            if (!response.ok) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2a010bea._.js.map