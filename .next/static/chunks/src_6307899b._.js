...
const page = ()=>{
    ...
    const handleGetBlog = async ()=>{
        setLoading(true);
        try {
            const response = await fetch("http://localhost:1337/api/blogs/".concat(params.slug, "?populate[subContent][populate]=*&populate[cate][populate]=*&populate[optionImage][populate]=*&populate=cover"), {
                method: "GET"
            });
            const data = await response.json();
            if (!response.ok) {
...
_s(page, "ub9ISnHeTP2zJ4oFEUuIoNKp7GU=", false, function() {
    return [
...
//# sourceMappingURL=src_6307899b._.js.map