...
const CatePage = ()=>{
    ...
    const handleGetBlogs = async ()=>{
        setLoading(true);
        try {
            const res = await fetch("http://localhost:1337/api/blogs?filters[cate][documentId][$eq]=".concat(params.slug, "&populate=cover&pagination[page]=").concat(page, "&pagination[pageSize]=3"));
            const data = await res.json();
            setBlogs(data.data);
...
//# sourceMappingURL=src_0650a12a._.js.map